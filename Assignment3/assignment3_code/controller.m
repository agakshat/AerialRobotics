...
cmd_accel=des_state.acc + Kd.*(des_state.vel-state.vel) + ...
...
phi_des = (1/params.gravity)*(cmd_accel(1)*sin(des_state.yaw) - ...
    cmd_accel(2)*cos(des_state.yaw));
theta_des = (1/params.gravity)*(cmd_accel(1)*cos(des_state.yaw) + ...
